...
Handles: logging helpers, run_benchmark_task, run_benchmark_queue_task
"""
...
async def run_benchmark_task(run_id: str, model_id: str, judge_model_id: Optional[str]):
    global _benchmark_running
    from services.judge_svc import judge_benchmark, get_gold_key, get_quantization_from_name, get_llm_server_url
