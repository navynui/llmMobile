...
with open("src/components/chat-tab.js", "r") as f:
    content = f.read()

os.makedirs("src/components/chat-tab", exist_ok=True)

# 1. _styles.js
styles_code = "import { css } from 'lit';\n\nexport const chatStyles = " + content[content.find("css`"):content.find("`;", content.find("css`")) + 2] + "\n"
with open("src/components/chat-tab/_styles.js", "w") as f:
    f.write(styles_code)

# 2. _logic.js
logic_code = """import { Confirm } from '../../components/_confirm.js';
...
"""
with open("src/components/chat-tab/_logic.js", "w") as f:
    f.write(logic_code)
...
"""
with open("src/components/chat-tab/_templates.js", "w") as f:
...
"""
with open("src/components/chat-tab.js", "w") as f:
    f.write(main_code)
