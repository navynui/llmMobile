...
with open("src/components/models-config-editor.js", "r") as f:
    content = f.read()

os.makedirs("src/components/models-config-editor", exist_ok=True)

# 1. _styles.js
styles_code = "import { css } from 'lit';\nimport { cardStyles, buttonStyles } from '../_primitives.js';\n\nexport const modelsConfigStyles = " + content[content.find("css`"):content.find("`;", content.find("css`")) + 2] + "\n"
with open("src/components/models-config-editor/_styles.js", "w") as f:
    f.write(styles_code)

# 2. _logic.js
logic_code = """export function handleSelectModelChange(ctx, e) {
...
"""
with open("src/components/models-config-editor/_logic.js", "w") as f:
    f.write(logic_code)
...
"""
with open("src/components/models-config-editor/_templates.js", "w") as f:
    f.write(templates_code)

# 4. models-config-editor.js (main)
...
"""
with open("src/components/models-config-editor.js", "w") as f:
    f.write(main_code)
